...
def score(touching_power_pellet, touching_dot):
    ...
    """
    if touching_dot and not touching_power_pellet:
        return True
    elif not touching_dot and touching_power_pellet:
        return touching_power_pellet
    else:
        return False
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    if has_eaten_all_dots is True :
        if power_pellet_active is False and touching_ghost is True:
            return False
        elif power_pellet_active is False and touching_ghost is False:
            return True
        else:
            return True
    else:
